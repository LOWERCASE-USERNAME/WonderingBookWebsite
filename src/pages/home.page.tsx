  ...
  return (
    <>
      ...
      <section className="p-4">
        ...
        <HorizontalScrollable className="flex overflow-x-auto gap-x-8" defaultScrollAmount={300}>
          {fav.map((_, idx) =>
            <div
              key={idx}
              className="relative grid h-[400px] flex-[0_0_300px] w-full max-w-[300px] flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700 select-none">
              <div
              ...
              <div className="relative">
                <div className="flex items-end ml-4">
                  ...
                  <h5 className="inline-block ml-2 font-sans antialiased font-light leading-snug tracking-tight text-gray-200">
                    - Tran Hoang Giang
                  </h5>
                </div>

                <h3 className="block m-4 mt-2 mb-0 text-xl font-sans font-medium leading-[1.1] tracking-normal text-white antialiased text-left">
      ...
      <section className="py-64 bg-pink-950">
        <HorizontalScrollable
          className="flex overflow-x-hidden gap-x-8 snap-x snap-mandatory"
        ...
        >
          {fav.map((_, idx) =>
            <div
              key={idx}
              className="flex-[0_0_100vw] snap-center">
